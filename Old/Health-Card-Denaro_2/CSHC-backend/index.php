...
<html lang="en">
<head>
    <title>Seniors Health Care Card Calculator Backend</title>
    <meta charset="utf-8">
...
<div class="container py-5">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="text-center Raleway">Seniors Health Care Card Calculator Backend</h1>
...
<script>
    ...
    function updateIncomeTest(id1) {
        let annual_income = document.getElementById('annual_income'+id1).value;
