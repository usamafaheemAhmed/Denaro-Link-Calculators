...
$data = array("income_id" => "", "situation" => "","weekly_income" => "","eight_week_income" => "");
$data1 = array("income_id" => "", "situation" => "","weekly_income" => "","eight_week_income" => "");
...
while($row = mysqli_fetch_array($result)) {
         if ($row["income_id"] == 1) {
          ...
          $data["weekly_income"] = $row["weekly_income"];
          $data["eight_week_income"] = $row["eight_week_income"];
         }
         if($row["income_id"] == 2){
          $data1["income_id"] = $row["income_id"];
          $data1["situation"] = $row["situation"];
          $data1["weekly_income"] = $row["weekly_income"];
          $data1["eight_week_income"] = $row["eight_week_income"];
         }
