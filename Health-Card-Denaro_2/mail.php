...
// Instantiation and passing `true` enables exceptions
    ...
    try {
        ...
        file_put_contents('./CSHC Card Calculator Report.pdf', $pdfData);
        ...
        $mail->Username = 'denarolink@denarowealth.com.au';                         // SMTP username
        $mail->Password = 'Centrelink2022';                               // SMTP password
...
//Recipients
        ...
        $mail->Subject = 'CSHC Card Calculator Report';
        $mail->Body = '
        ...
        * {
        ...
        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="font-family: "Raleway",sans-serif; font-size: 9px; line-height: 140%; text-align: justify; word-wrap: break-word;">
            <p style="line-height: 140%;font-size: 9px;text-align: justify;">Denaro Wealth Pty Ltd, ABN 23 625 686 464. Corporate Authorised Representative (NO. 1263750) of Lifespan Financial Planning Pty Ltd ABN 23 065 921 735, Australian Financial Services Licensee and Australian Credit Licence No. 229892.</p>
          </div>
        ...
        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="font-family: "Raleway",sans-serif; font-size: 9px; line-height: 140%; text-align: justify; word-wrap: break-word;">
            <p style="line-height: 140%; font-size: 9px;text-align: justify;">Ground Floor, Corporate One, 84 Hotham Street, Preston VIC 3072.</p>
          </div>
        ...
        $mail->AddEmbeddedImage('./CSHC Card Calculator Report.pdf',"pdf");
