...
// Instantiation and passing `true` enables exceptions
    ...
    try {
        ...
        file_put_contents('./Health-Card-Denaro.pdf', $pdfData);
...
//Recipients
        ...
        $mail->Subject = 'Summary From Commonwealth Seniors Health Card Calculator';
        ...
        * {
        ...
        $mail->AddEmbeddedImage('./Health-Card-Denaro.pdf',"pdf");
